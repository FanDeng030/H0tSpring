...
var lyr__2 = new ol.layer.Vector({
                ...
                style: style__2,
                interactive: true,
                title: '<img src="styles/legend/_2.png" /> 鹼性水質'
            });
...
var lyr__3 = new ol.layer.Vector({
                ...
                style: style__3,
                interactive: true,
                title: '<img src="styles/legend/_3.png" /> 酸性水質'
            });
...
var lyr__4 = new ol.layer.Vector({
                ...
                style: style__4,
                interactive: true,
                title: '<img src="styles/legend/_4.png" /> 中性水質'
            });
...
var lyr__5 = new ol.layer.Vector({
                ...
                style: style__5,
                interactive: true,
                title: '<img src="styles/legend/_5.png" /> 無資料'
            });
...
var lyr__6 = new ol.layer.Vector({
                ...
                interactive: true,
    title: '依出露岩層屬性<br />\
    <img src="styles/legend/_6_0.png" /> 火成岩區<br />\
    <img src="styles/legend/_6_1.png" /> 沉積岩區<br />\
    <img src="styles/legend/_6_2.png" /> 變質岩區<br />'
        });
...
var lyr__7 = new ol.layer.Vector({
                ...
                style: style__7,
                interactive: true,
                title: '<img src="styles/legend/_7.png" /> 東部'
            });
...
var lyr__8 = new ol.layer.Vector({
                ...
                style: style__8,
                interactive: true,
                title: '<img src="styles/legend/_8.png" /> 南部'
            });
...
var lyr__9 = new ol.layer.Vector({
                ...
                style: style__9,
                interactive: true,
                title: '<img src="styles/legend/_9.png" /> 中部'
            });
...
var lyr__10 = new ol.layer.Vector({
                ...
                style: style__10,
                interactive: true,
                title: '<img src="styles/legend/_10.png" /> 北部'
            });
...
var lyr__11 = new ol.layer.Vector({
                ...
                style: style__11,
                interactive: true,
                title: '<img src="styles/legend/_11.png" /> 推薦溫泉'
            });
...
var lyr__12 = new ol.layer.Vector({
                ...
                style: style__12,
                interactive: true,
                title: '<img src="styles/legend/_12.png" /> 溫泉'
            });

lyr_GoogleSatellite_0.setVisible(true);lyr_GoogleMaps_1.setVisible(true);lyr__2.setVisible(true);lyr__3.setVisible(true);lyr__4.setVisible(true);lyr__5.setVisible(true);lyr__6.setVisible(true);lyr__7.setVisible(true);lyr__8.setVisible(true);lyr__9.setVisible(true);lyr__10.setVisible(true);lyr__11.setVisible(true);lyr__12.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_GoogleMaps_1,lyr__2,lyr__3,lyr__4,lyr__5,lyr__6,lyr__7,lyr__8,lyr__9,lyr__10,lyr__11,lyr__12];
...
lyr__12.set('fieldAliases', {'溫泉名稱': '溫泉名稱', '溫泉PH值': '溫泉PH值', '溫泉溫度': '溫泉溫度', '出露岩層屬': '出露岩層屬', '溫泉性質': '溫泉性質', '行政區': '行政區', 'X座標(TWD9': 'X座標(TWD9', 'Y座標(TWD9': 'Y座標(TWD9', '經度(WGS84': '經度(WGS84', '緯度(WGS84': '緯度(WGS84', '高程': '高程', });
...
lyr__5.set('fieldImages', {'溫泉名稱': '', '溫泉PH值': '', '溫泉溫度': '', '出露岩層屬': '', '溫泉性質': '', '行政區': '', 'X座標(TWD9': '', 'Y座標(TWD9': '', '經度(WGS84': '', '緯度(WGS84': '', '高程': '', });
...
lyr__12.set('fieldImages', {'溫泉名稱': 'TextEdit', '溫泉PH值': 'TextEdit', '溫泉溫度': 'TextEdit', '出露岩層屬': 'TextEdit', '溫泉性質': 'TextEdit', '行政區': 'TextEdit', 'X座標(TWD9': 'TextEdit', 'Y座標(TWD9': 'TextEdit', '經度(WGS84': 'TextEdit', '緯度(WGS84': 'TextEdit', '高程': 'TextEdit', });
...
lyr__6.set('fieldLabels', {'溫泉名稱': 'inline label', '溫泉PH值': 'inline label', '溫泉溫度': 'inline label', '出露岩層屬': 'inline label', '溫泉性質': 'inline label', '行政區': 'inline label', 'X座標(TWD9': 'no label', 'Y座標(TWD9': 'no label', '經度(WGS84': 'no label', '緯度(WGS84': 'no label', '高程': 'no label', });
...
lyr__12.set('fieldLabels', {'溫泉名稱': 'inline label', '溫泉PH值': 'inline label', '溫泉溫度': 'inline label', '出露岩層屬': 'inline label', '溫泉性質': 'inline label', '行政區': 'inline label', 'X座標(TWD9': 'inline label', 'Y座標(TWD9': 'inline label', '經度(WGS84': 'inline label', '緯度(WGS84': 'inline label', '高程': 'inline label', });
lyr__12.on('precompose', function(evt) {
